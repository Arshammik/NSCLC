...
GSE131907_pheno <- GSE131907_pheno %>%  select("title", "geo_accession", "characteristics_ch1.1", "source_name_ch1", "relation")
colnames(GSE131907_pheno) <- c("ID", "GSM", "tumor_stage", "tissue_source", "GEO")
